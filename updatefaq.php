            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="viewfaq.php"><button class="btn btn-primary" >Back</button></a>
                  </div>
                </div>
                      ...
                      <div class="form-builder-column">
                        ...
                        <?php
                          if(isset($_POST["updatebtn"])){
                            ...
                            $sql=mysqli_query($conn,"select * from tbl_faq where questions='$question'");
                            if($row=mysqli_num_rows($sql)==0){
                              $result= mysqli_query($conn,"update tbl_faq set questions='$question',answer='$answer' where faq_id='$uid'")
                              ...
                              if($result == true){
                                ?>
                                    ...
                                    echo "<script>window.location='viewfaq.php'</script>";
                            ...
                            <div class="tab-content" id="pills-tabContent">
                              ...
                              <?php
                                 if ($_GET["updateid"]) {
                                  ...
                                  $result = mysqli_query($conn,"select * from tbl_faq where faq_id='$uid'") or die(mysqli_error($conn));
                                  while ($row = mysqli_fetch_assoc($result)) {
                                ?>
                                <form id="form1" method="post" enctype="multipart/form-data">
                                  <div class="mb-3 draggable">
                                    <label for="question">Questions</label>
                                    <input class="form-control btn-square" value="<?php echo $row["questions"];?>" name="question" id="question" type="text" placeholder="Please Enter Questions">
                                   
                                  </div>
                                  <div class="mb-3 draggable">
                                    <label for="answer">Answer</label>
                                    <input class="form-control btn-square" value="<?php echo $row["answer"];?>" name="answer" id="answer" type="text" placeholder="Please Enter Answer">
