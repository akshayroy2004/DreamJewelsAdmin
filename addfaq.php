                      ...
                      <div class="form-builder-column">
                        ...
                        <?php
                          if(isset($_POST["addbtn"])){
                            ...
                            $sql = mysqli_query($conn,"select * from tbl_faq where questions='$question' and answer='$answer'");

                            if($row = mysqli_num_rows($sql)==0)
                            {
                              $result= mysqli_query($conn,"insert into tbl_faq(questions,answer) values('$question','$answer')") or die (mysqli_error($conn));
                              if($result == true){
                                ?>
                              ...
                              <div class="tab-pane fade show active" id="pills-input" role="tabpanel" aria-labelledby="pills-input-tab">
                                <form id="form1" method="post">
                                  <div class="mb-3 draggable">
                                    ...
                                    <input class="form-control btn-square" name="question" id="question" type="text" placeholder="Please Enter Questions">
                                   
                                  </div>
                                  <div class="mb-3 draggable">
                                    <label for="answer">Answer</label>
                                    <input class="form-control btn-square" name="answer" id="answer" type="text" placeholder="Please Enter Answer">
