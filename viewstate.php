            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="addstate.php"><button class="btn btn-primary" >Add</button></a>
                      ...
                      <table class="display" id="basic-1">
                        ...
                        <?php 
                          $count = 1;
                            ...
                            <td>
                            <a href="updatestate.php?updateid=<?php echo $row["state_id"];?>"><button class="btn btn-secondary" >Update</button></a>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["state_id"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
