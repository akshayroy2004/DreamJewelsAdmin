            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="addshape.php"><button class="btn btn-primary" >Add</button></a>
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
               ...
               if(isset($_POST["deletebtn"]))
               {
                ...
                $result = mysqli_query($conn,"delete from shape where shape_id='$id'");
                      ...
                      <table class="display" id="basic-1">
                        ...
                        <?php 
                          $count = 1;
                            ...
                            <td>
                            <a href="updateshape.php?updateid=<?php echo $row["shape_id"];?>"><button class="btn btn-secondary" >Update</button></a>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["shape_id"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
