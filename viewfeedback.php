            ...
            <div class="row">
              ...
              <div class="col-sm-12">
               ...
               if(isset($_POST["deletebtn"]))
               {
                ...
                $result = mysqli_query($conn,"delete from tbl_feedback where feedback_id='$id'");
                      ...
                      <table class="display" id="basic-1">
                        ...
                        <?php 
                          $count = 1;
                            ...
                            <td><?php echo $row["feedback_date_time"]; ?></td>
                            <!-- <td>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["feedback_id"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
