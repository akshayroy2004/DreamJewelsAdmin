            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="addfaq.php"><button class="btn btn-primary">Add</button></a>
                  </div>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="basic-1">
                        ...
                        <?php 
                          $count = 1;
                            $result = mysqli_query($conn,"select * from tbl_faq") or die (mysqli_error($conn));
                            ...
                            <td>
                            <a href="updatefaq.php?updateid=<?php echo $row["faq_id"];?>"><button class="btn btn-secondary" >Update</button></a>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["faq_id"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
