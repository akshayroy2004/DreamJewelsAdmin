            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="vieworder.php"><button class="btn btn-primary" >Back</button></a>
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
               ...
               if(isset($_POST["deletebtn"]))
               {
                ...
                $result = mysqli_query($conn,"delete from tbl_order where order_id='$id'");
                    ...
                    <div class="table-responsive">
                      ...
                      <?php
                       if(isset($_GET["viewid"])){
                        ...
                        // $result = mysqli_query($conn,"select * from tbl_order as o left join user as u on o.user_id=u.user_id left join tbl_city as c on o.city_id=c.city_id left join tbl_offer as of on o.offer_id=o.offer_id" where order_id ='$id'") or die (mysqli_error($conn));
                        $result = mysqli_query($conn,"select * from tbl_order as o left join user as u on o.user_id=u.user_id left join tbl_city as c on o.city_id=c.city_id left join tbl_offer as of on o.offer_id=of.offer_id where order_id='$id'") or die (mysqli_error($conn));
