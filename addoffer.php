                      ...
                      <div class="form-builder-column">
                        ...
                        <?php
                            if(isset($_POST["addbtn"])){
                              ...
                              $code=$_POST["code"];
                                  $result = mysqli_query($conn,"insert into tbl_offer(title,min_amount,max_amount,discount,isactive,code) values ('$title','$minamount','$maxamount',' $discount','$isactive','$code')") or die (mysqli_error($conn));
                                  if($result == true)
                                  {
                                    ?>
                              ...
                              <div class="tab-pane fade show active" id="pills-input" role="tabpanel" aria-labelledby="pills-input-tab">
                                <form id="form1" method="post">
                                  <div class="mb-3 draggable">
                                    ...
                                    <input class="form-control btn-square" name="title" id="title" type="text" placeholder="Please Enter Title">
                                   
                                  </div>
                                  <div class="mb-3 draggable">
                                    <label for="min">Minmum Amount</label>
                                    <input class="form-control btn-square" name="min" id="min" type="number" placeholder="Please Enter Minmum Amount">
                                   
                                  </div>
                                  <div class="mb-3 draggable">
                                    <label for="max">Maximum Amount</label>
                                    <input class="form-control btn-square" name="max" id="max" type="number" placeholder="Please Enter Minmum Amount">
                                  </div>
                                  <div class="mb-3 draggable">
                                    <label for="discount">Discount </label>
                                    <input class="form-control btn-square" name="discount" id="discount" type="text" placeholder="Please Enter Discount">
                                ...
                                <div>
                                 ...
                                 <div class="mb-3 draggable">
                                    ...
                                    <input class="form-control btn-square" name="code" id="code" type="number" placeholder="Please Enter Code">
                                  </div>
                                  <br>
                                 <div>
          ...
          $("#form1").validate({
            ...
            messages:
            {
              ...
              min:
              {
                ...
                min:"please enter gratedthan 1000"
              },
              max:{
                required:"Please Enter Minmum Amount",
                max:"please enter lessthan 100"
              },
              discount:{
