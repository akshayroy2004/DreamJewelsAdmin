                    ...
                    <div class="form-builder-column">
                      <div class="row">
                        ...
                        if (isset($_POST["addbtn"])) {
                          ...
                          $sql = mysqli_query($conn,"select * from subcategory where subcat_name='$subcatname'");
                          if($row = mysqli_num_rows($sql)==0)
                          {
                            $result = mysqli_query($conn, "insert into subcategory(subcat_name,subcat_img,cat_id) values ('$subcatname','$filename','$catid')")
                            ...
                            <div class="tab-pane fade show active" id="pills-input" role="tabpanel" aria-labelledby="pills-input-tab">
                              <form id="form1" method="post" enctype="multipart/form-data">
                                <div class="mb-3 draggable">
                                  ...
                                  <select class="form-control btn-square" name="txtcatid" id="txtcatid" placeholder="Please Enter category name">
                                ...
                                <div class="mb-3 draggable">
                                  ...
                                  <input class="form-control btn-square" name="txtname" id="txtname" type="text" placeholder="Please Enter SubCategory Name">
                                </div>
  ...
  <script>
      ...
      $(document).ready(function(){
          $("#form1").validate({
            ...
            {
              txtcatid:{
                required:"Please Select Catagory Name"
              },
              txtname:
              {
