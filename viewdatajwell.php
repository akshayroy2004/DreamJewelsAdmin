          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="">
                    <table border="1" class="display" id="basic-1">
                      ...
                      <tbody>
                        ...
                        if (isset($_GET["viewid"])) {
                          ...
                          $result = mysqli_query($conn, "select * from jewellery as j left join subcategory as sub on j.subcat_id=sub.subcat_id left join type as t on j.type_id=t.type_id left join carat as c on j.carat_id=c.carat_id left join shape as s on j.shape_id=s.shape_id where jewellery_id='$id'") or die(mysqli_error($conn));
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><video src="video/<?php echo $row["video_url"]; ?>" controls height="500px" width="500px" alt="">></video></td>
                        </tr>
