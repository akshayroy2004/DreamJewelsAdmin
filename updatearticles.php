                    ...
                    <div class="card-body form-builder">
                      <div class="form-builder-column">
                        ...
                        <?php
                          ...
                          {
                            unlink("uploads/articles/".$oldimg);
                            ...
                            echo $newimg;
                              ...
                              $ref="abc.jpg";
                              $uid = $_GET["updateid"];
                                  $result = mysqli_query($conn,"update tbl_articles set title='$title1',discription='$discription',img_url='$newimg',isdisplay='$isdisplay',ref_website_url='$ref' where articles_id='$uid'")or die (mysqli_error($conn));
                                  if($result == true){
                                    ?>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                              ...
                              <?php
                                if ($_GET["updateid"]) {
                                  ...
                                  $result = mysqli_query($conn, "select * from tbl_articles where articles_id='$uid'") or die(mysqli_error($conn));
                                ...
                                <form id="form1" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="mb-3 draggable">
                                    ...
                                    <input class="form-control btn-square" value="<?php echo $row["discription"];?>"  name="txtdesc" id="txtdesc" type="text" placeholder="Please Enter Description">
                                 </div>
                                 ...
                                 <div class="mb-3 draggable">
                                    ...
                                    <input class="form-control btn-square"  name="imgurl1" id="imgurl1" type="file" placeholder="valid image">
                                    <img src="uploads/articles/<?php echo $row["img_url"]; ?>" height="100px" width="100px" alt="">
                                 </div>
                                 <div>
                                    <label for="radio1">Is Display</label>
                                </div>
                                 <div class="radio radio-theme">
                                    <input id="radioinline1" checked type="radio"  value="<?php echo $row["isdisplay"];?>" name="radio1" value="yes">
                                 ...
                                 <div class="mb-3 draggable">
                                    ...
                                    <input class="form-control btn-square" value="<?php echo $row["ref_website_url"];?>" name="imgurl" id="imgurl" type="text">
                                 </div>
