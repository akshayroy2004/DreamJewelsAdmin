            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="viewstate.php"><button class="btn btn-primary" >Back</button></a>
                  </div>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                      ...
                      <div class="form-builder-column">
                        ...
                        <?php
                          if(isset($_POST["updatebtn"])){
                            $statename=$_POST["txtname"];
                            $uid = $_GET["updateid"];
                            $sql = mysqli_query($conn,"select * from tbl_state where state_name='$statename'");
                            if($row = mysqli_num_rows($sql)==0)
                            {
                              $result= mysqli_query($conn,"update tbl_state set state_name='$statename' where state_id='$uid'") or die (mysqli_error($conn));
                              if($result == true){
                            ...
                            <div class="tab-content" id="pills-tabContent">
                              <div class="tab-pane fade show active" id="pills-input" role="tabpanel" aria-labelledby="pills-input-tab">
                                ...
                                if($_GET["updateid"]){
                                  ...
                                  $result = mysqli_query($conn, "select * from tbl_state where state_id='$uid'") or die(mysqli_error($conn));
                                  while ($row = mysqli_fetch_assoc($result)) {
                               
                                ?>
                                <form id="form1" method="post">
                                  <div class="mb-3 draggable">
                                    <label for="txtname">State Name</label>
                                    <input class="form-control btn-square" value="<?php echo $row["state_name"];?>" name="txtname" id="txtname" type="text" placeholder="Please Enter State Name">
