                        ...
                        <?php 
                            if(isset($_POST["addbtn"]))
                            {
                              // echo "yes";
                                ...
                                $result = mysqli_query($conn,"insert into tbl_gallery(title,img_url,isdisplay) values ('$title','$filename','$isdisplay')") or die (mysqli_error($conn));
                                if($result == true)
                                {
                                  ?>
                              ...
                              <div class="tab-pane fade show active" id="pills-input" role="tabpanel" aria-labelledby="pills-input-tab">
                                <form id="form1" method="post" enctype="multipart/form-data">
                                  <div class="mb-3 draggable">
                                    ...
                                    <input class="form-control btn-square" name="txttitle" id="txttitle" type="text" placeholder="Enter Title">
                                 ...
                                 <div class="mb-3 draggable">
                                    ...
                                    <input class="form-control btn-square" name="img_url" id="img_url" type="file" placeholder="valid image">
                                 </div>
                                 <div>
