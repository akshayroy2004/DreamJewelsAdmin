                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="basic-1">
                        ...
                        <?php 
                          $count = 1;
                            $result = mysqli_query($conn,"select * from tbl_cart as c left join user as u on c.user_id=u.user_id left join jewellery as j on c.jewellery_id=j.jewellery_id") or die (mysqli_error($conn));
                            ...
                            <td><?php echo $row["address_date_time"]; ?></td>
                            <!-- <td>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["cart_id"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
