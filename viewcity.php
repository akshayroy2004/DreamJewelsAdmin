            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="justify-right">
                  <a href="addcity.php"><button class="btn btn-primary">Add</button></a>
            ...
            <div class="col-sm-12">
              <div class="card">
               ...
               if(isset($_POST["deletebtn"]))
               {
                ...
                $result = mysqli_query($conn,"delete from tbl_city where city_id='$id'");
                  ...
                  <div class="table-responsive">
                    <table class="display" id="basic-1">
                      ...
                      <tbody>
                        <?php
                        $count = 1;
                        $result = mysqli_query($conn, "select * from tbl_city as c left join tbl_state as s on c.state_id=s.state_id") or die(mysqli_error($conn));
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                            <a href="updatecity.php?updateid=<?php echo $row["city_id"];?>"><button class="btn btn-secondary">Update</button></a>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["city_id"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
