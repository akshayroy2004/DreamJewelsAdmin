            ...
            <div class="row">
              ...
              <?php 
               ...
               if(isset($_POST["deletebtn"]))
               {
                ...
                $result = mysqli_query($conn,"delete from tbl_details where details_id='$id'");

                if($result)
                {
                  echo "<script>window.location='viewdetails.php'</script>";
                }
                else
                {
                  echo "error";
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="basic-1">
                        ...
                        <?php 
                          $count = 1;
                            $result = mysqli_query($conn,"select * from tbl_details as d left join tbl_order as o on d.order_id=o.order_id left join jewellery as j on d.jewellery_id=j.jewellery_id") or die (mysqli_error($conn));
                            ...
                            <!-- <td>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["details_id"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
