            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="viewcity.php"><button class="btn btn-primary" >Back</button></a>
                  </div>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                      ...
                      <div class="form-builder-column">
                        ...
                        <?php
                          if(isset($_POST["updatebtn"])){
                            ...
                            $sql = mysqli_query($conn,"select * from tbl_city where city_name='$cityname'");
                            if($row = mysqli_num_rows($sql)==0)
                            {
                              $result= mysqli_query($conn,"update tbl_city set city_name='$cityname',state_id='$statename',delivery_charge='$delivery' where city_id='$uid'")
                            ...
                            <div class="tab-content" id="pills-tabContent">
                              ...
                              <?php
                                ...
                                if ($_GET["updateid"]) {
                                  ...
                                  $result = mysqli_query($conn, "select * from tbl_city where city_id='$uid'") or die(mysqli_error($conn));
                                  while ($row = mysqli_fetch_assoc($result)) {
                                ?>
                                <form id="form1" method="post">
                                  <div class="mb-3 draggable">
                                    <label for="txtname">City Name</label>
                                    <input class="form-control btn-square" value="<?php echo $row["city_name"];?>"  name="txtname" id="txtname" type="text" placeholder="Please Enter City Name">
                                   
                                  </div>
                                  <div class="mb-3 draggable">
                                  <label for="state">State Name</label> 
                                  <select class="form-control btn-square" value="<?php echo $row["state_id"];?>"  name="state" id="state">
                                  ...
                                  <div class="mb-3 draggable">
                                    ...
                                    <input class="form-control btn-square" value="<?php echo $row["delivery_charge"];?>" name="delivery" id="delivery" type="text" placeholder="Please Enter Delivery Charge">
                                  </div>
