            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="addcarat.php"><button class="btn btn-primary" >Add</button></a>
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
               ...
               if(isset($_POST["deletebtn"]))
               {
                ...
                $result = mysqli_query($conn,"delete from carat where carat_id='$id'");
                      ...
                      <table class="display" id="basic-1">
                        ...
                        <?php 
                          $count = 1;
                            ...
                            <td>
                            <a href="updatecarat.php?updateid=<?php echo $row["carat_id"];?>"><button class="btn btn-secondary" >Update</button></a>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["carat_id"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
