                    ...
                    <div class="form-builder-column">
                      <div class="row">
                        ...
                        if (isset($_POST["addbtn"])) {
                          ...
                          {
                            $result = mysqli_query($conn, "insert into category(cat_name,cat_img) values ('$catname','$filename')") or die(mysqli_error($conn));
                            if ($result == true) {
                            ...
                            <div class="tab-pane fade show active" id="pills-input" role="tabpanel" aria-labelledby="pills-input-tab">
                              <form id="form1" method="post" enctype="multipart/form-data">
                                <div class="mb-3 draggable">
                                  ...
                                  <input class="form-control btn-square" name="txtname" id="txtname" type="text" placeholder="Enter Category Name">
