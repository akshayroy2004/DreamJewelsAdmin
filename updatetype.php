            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="justify-right">
                  <a href="viewtype.php"><button class="btn btn-primary" >Back</button></a>
                  </div>
              </div>
              <div class="col-sm-6">
                <!-- Bookmark Start-->
                    ...
                    <div class="form-builder-column">
                      <div class="row">
                        ...
                        if (isset($_POST["updatebtn"])) {
                          ...
                          $sql = mysqli_query($conn,"select * from type where type_name='$typename'");
                          if($row = mysqli_num_rows($sql)==0)
                          {
                            $result = mysqli_query($conn,"update type set type_name='$typename' where type_id='$uid'") or die(mysqli_error($conn));
                            if ($result == true) {
                        ...
                        if ($_GET["updateid"]) {
                          ...
                          $result = mysqli_query($conn, "select * from type where type_id='$uid'") or die(mysqli_error($conn));
                          while ($row = mysqli_fetch_assoc($result)) {
                        ?>
                       
                              <form id="form1" method="post">
                                <div class="mb-3 draggable">
                                  <label for="txtname">Type Name</label>
                                  <input class="form-control btn-square" value="<?php echo $row["type_name"];?>" name="txtname" id="txtname" type="text" placeholder="Enter Type Name">
