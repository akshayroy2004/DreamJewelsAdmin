            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="addcat.php"><button class="btn btn-primary" >Add</button></a>
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
               ...
               if(isset($_POST["deletebtn"]))
               {
                ...
                $result = mysqli_query($conn,"delete from category where cat_id='$id'");
                      ...
                      <table class="display" id="basic-1">
                        ...
                        <?php 
                          $count = 1;
                            ...
                            <td><img src="uploads/category/<?php echo $row["cat_img"]; ?>" height="100px" width="100px" alt=""></td>
                            <td>
                            <a href="updatecat.php?updateid=<?php echo $row["cat_id"];?>"><button class="btn btn-secondary" >Update</button></a>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["cat_id"]; ?>" data-img="<?php echo $row["cat_img"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
