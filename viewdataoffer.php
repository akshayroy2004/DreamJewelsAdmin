            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="viewoffer.php"><button class="btn btn-primary" >View</button></a>
                    ...
                    <div class="table-responsive">
                      ...
                      <?php
                       if(isset($_GET["viewid"])){
                        ...
                        $result = mysqli_query($conn,"select * from tbl_offer where offer_id='$id'") or die (mysqli_error($conn));
