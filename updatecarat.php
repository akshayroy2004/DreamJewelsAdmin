                      ...
                      <div class="form-builder-column">
                        ...
                        <?php
                          if(isset($_POST["updatebtn"])){
                            ...
                            {
                              $result= mysqli_query($conn,"update carat set carat_name='$caratname' where carat_id='$uid'")
                            ...
                            <div class="tab-content" id="pills-tabContent">
                              ...
                              <?php
                                if ($_GET["updateid"]) {
                                  ...
                                  $result = mysqli_query($conn, "select * from carat where carat_id='$uid'") or die(mysqli_error($conn));
                                  while ($row = mysqli_fetch_assoc($result)) {
                                ?>
                              <form id="form1" method="post">
                                  <div class="mb-3 draggable">
                                    <label for="txtname">Carat Name</label>
                                    <input class="form-control btn-square"value="<?php echo $row["carat_name"];?>" name="txtname" id="txtname" type="text" placeholder="Enter Carat Name">
