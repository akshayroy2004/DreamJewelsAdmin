            ...
            <div class="page-header">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="addoffer.php"><button class="btn btn-primary" >Add</button></a>
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
               ...
               if(isset($_POST["deletebtn"]))
               {
                ...
                $result = mysqli_query($conn,"delete from tbl_offer where offer_id='$id'");
...
$result = mysqli_query($conn,"update tbl_offer set isactive='$isactive' where offer_id='$id'");
}
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="basic-1">
                        ...
                        <?php 
                          $count = 1;
                            $result = mysqli_query($conn,"select * from tbl_offer") or die (mysqli_error($conn));
  ...
  if($row["isactive"] == "yes")
  {
    ...
    ?>
     ...
     <button type="submit" class="btn btn-primary" name="btnactive">Yes</button>
      ...
      <input type="hidden" name="dataid" value="<?php echo $row["offer_id"];?>">
     </form>
...
?>
                            ...
                            <td>
                            <a href="viewdataoffer.php?viewid=<?php echo $row["offer_id"]?>"><button class="btn btn-primary" >View</button></a>
                            <a href="updateoffer.php?updateid=<?php echo $row["offer_id"];?>"><button class="btn btn-secondary" >Update</button></a>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["offer_id"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
