...
$result = mysqli_query($conn,"update user set isverify='$isverify' where user_id='$id'");
}
...
$result = mysqli_query($conn,"update user set isblock='$isblock' where user_id='$id'");
}
...
<?php 
  ...
  if($row["isblock"] == "yes")
  {
    ...
    ?>
     ...
     <form method="post">
     <button type="submit" class="btn btn-primary" name="btnblock">Yes</button>
  ...
  else
  {
    ...
    <form method="post">
    <button type="submit" class="btn btn-danger" name="btnblock">No</button>
...
?>
                            ...
                            <td>
                            <a href="viewdatauser.php?viewid=<?php echo $row["user_id"]?>"><button class="btn btn-primary" >View</button></a>
                            <!-- <a href="updateuser.php?updateid=<?php echo $row["user_id"]; ?>"><button class="btn btn-secondary" >Update</button></a>
                            <button type="submit" class="btndelete" data-id="<?php echo $row["user_id"]; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button> -->
